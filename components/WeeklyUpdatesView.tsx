      ...
      <div className="text-zinc-100 font-sans selection:bg-[#FABE01] selection:text-black">
        <header className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-white tracking-tight flex items-center gap-3">
            <Target className="w-8 h-8 text-[#FABE01] shrink-0" />
            Foco da Semana
          </h1>
          <p className="text-zinc-400 mt-2 text-base md:text-lg max-w-2xl leading-relaxed">
            Acompanhe em tempo real as prioridades e entregas da semana.
          </p>
        </header>
        ...
        <div className="max-w-4xl mx-auto pb-20"> {/* pb-20 para dar espaço no mobile */}
          ...
          <div className="bg-[#1A1A1A] border border-white/5 rounded-sm p-6 mb-6 shadow-lg">
            ...
            <div className="w-full bg-[#111111] rounded-full h-1.5 overflow-hidden">
              <div className="bg-[#FABE01] h-full rounded-full transition-all duration-500 ease-out shadow-[0_0_10px_#FABE01]" style={{ width: `${progress}%` }} />
            </div>
          </div>
              ...
              {isLoading ? (
                  ...
                  tasks.map(task => (
                      ...
                      >
                        ...
                        <span className={`flex-1 text-sm sm:text-base font-medium transition-all break-words ${task.completed ? 'text-zinc-500 line-through decoration-zinc-700' : 'text-zinc-200'}`}>
                                {task.text}
                            </span>
