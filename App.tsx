...
const PortalLayout: React.FC<PortalLayoutProps> = ({
    ...
    const [pending, setPending] = useState<PendingCounts>({ aguardandoCliente: 0, aguardandoAgencia: 0, total: 0, noMes: 0, publicados: 0, semCapa: 0, atrasados: 0, atrasadosCliente: 0, semPrazo: 0 });
