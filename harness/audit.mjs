...
const SCREENS = ['login','signup','verificacao','perfil-obrigatorio','perfil','painel','cliente-workspace','calendario','calendario-cliente','producao','semana','arquivos','relatorios','ficha-cliente','ficha-cliente-colab','modal','thumb','materiais','materiais-cliente','home-cliente','andamento','pessoa-card','pessoa-ficha','pessoa-ficha-colab','pessoa-ficha-cliente','configuracoes','configuracoes-colab','modal-gestao','modal-cliente','modal-midia','modal-novo','midia-e-pastas','previa-carrossel','calendario-agencia','cliente-workspace-tarefa','tarefas'];
