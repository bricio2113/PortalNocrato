...
const SCREENS = ['login','signup','verificacao','perfil-obrigatorio','perfil','painel','cliente-workspace','calendario','calendario-cliente','producao','semana','arquivos','relatorios','ficha-cliente','ficha-cliente-colab','modal','thumb'];
